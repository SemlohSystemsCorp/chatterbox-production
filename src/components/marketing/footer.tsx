...
const LINKS = {
  ...
  legal: [
    ...
    { label: "Contact", href: "mailto:hello@georgeholmes.io" },
  ],
};
      ...
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid grid-cols-2 gap-10 sm:grid-cols-4 lg:grid-cols-5">
          ...
          <div className="col-span-2 sm:col-span-4 lg:col-span-2">
            <Link href="/" className="mb-4 flex items-center gap-2.5">
              ...
              <span className="text-base font-semibold text-foreground">Chatterbox</span>
            </Link>
            <p className="mb-6 max-w-[260px] text-sm leading-relaxed text-muted-foreground">
              Fast, clean team communication. Channels, threads, DMs, and video — all in one place.
            </p>
            {/* Social */}
            <div className="flex items-center gap-3">
              {[
                ...
                {
                  label: "GitHub",
                  href: "https://github.com/georgeholmes",
                  icon: (
                    <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-3 border-t border-border/60 pt-8 sm:flex-row">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Chatterbox by{" "}
            <a
